        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            ...
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-10">
                <nav class="flex items-center gap-1.5 text-base text-slate-400" aria-label="<?php esc_attr_e('Breadcrumb', 'meritoros'); ?>">
                    ...
                    <span>/</span>
                    <a href="<?php echo esc_url($hk_url); ?>" class="hover:text-[#00d084] transition-colors"><?php esc_html_e('Historie klientów', 'meritoros'); ?></a>
                    <span>/</span>
            ...
            <div class="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-6 mb-10">
                ...
                <div class="shrink-0 flex flex-col items-start sm:items-end gap-2 sm:pt-2">
                    ...
                    <a href="<?php echo esc_url($logo_url); ?>"
                       ...
                       class="text-sm text-slate-400 hover:text-[#00d084] transition-colors duration-200 flex items-center gap-1">
    ...
    <section class="py-14 md:py-20">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="max-w-4xl">
                ...
                <h2 class="text-pretty text-3xl md:text-4xl lg:text-5xl font-bold text-[#00d084] mb-6">
                ...
                <ul class="space-y-4 mb-8">
                    ...
                    <li class="flex items-start gap-4">
                        <span class="flex-shrink-0 mt-1 w-6 h-6 rounded-full bg-[#00d084] flex items-center justify-center">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
                ...
                <div class="rounded-2xl border border-slate-200 bg-white p-7 flex flex-col gap-5">
                    <i data-lucide="circle-check" class="w-7 h-7 text-[#00d084] flex-shrink-0" stroke-width="1.5"></i>
                    <div>
