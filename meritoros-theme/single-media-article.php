...
.toc-link.is-active { border-left-color: #48c279; color: #16a34a; font-weight: 600; }
</style>
    ...
    <section class="pt-32 md:pt-44 pb-16 md:pb-20 bg-white relative">
        ...
        <div class="max-w-4xl mx-auto px-6 relative z-10">
            ...
            <div class="flex items-center gap-3 mb-6">
                <?php if ($source) : ?>
                    <span class="text-xs font-semibold text-white bg-[#48c279] px-3 py-1 rounded-full">
            ...
            <div class="flex flex-col lg:flex-row gap-12 xl:gap-16">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <div class="prose prose-slate prose-lg max-w-none
                                ...
                                prose-a:text-[#48c279] prose-a:no-underline hover:prose-a:underline
                ...
                <aside class="hidden lg:block w-52 xl:w-60 flex-shrink-0">
                    <div class="sticky top-24">
                        ...
                        <div class="mb-8 pb-8 border-b border-slate-100">
                            <?php if ($source) : ?>
                                <span class="inline-block text-xs font-semibold text-white bg-[#48c279] px-3 py-1 rounded-full mb-3">
                                    <?php echo mer_esc($source); ?>
                                </span>
                            <?php endif; ?>
