...
<section class="py-10 md:py-20 bg-white relative">
    <div class="max-w-7xl mx-auto px-6 mb-10 flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
        ...
        <div class="flex items-center gap-2 shrink-0">
            ...
            <button id="uk-historie-next" type="button" class="w-12 h-12 rounded-full bg-[#48c279] flex items-center justify-center shadow-md hover:bg-[#3ea868] transition-colors">
            ...
            <?php foreach ($slides as $idx => $slide) : ?>
                <div class="min-w-[85%] sm:min-w-[calc(50%-12px)] lg:w-[400px] lg:min-w-[400px] rounded-2xl overflow-hidden border border-slate-200 flex flex-col">
                    ...
                    <div class="p-5 flex flex-col flex-1">
                        ...
                        <a href="<?php echo esc_url($btn_url); ?>" class="mt-auto inline-flex px-5 py-2.5 rounded-full bg-[#48c279] text-white text-xs font-semibold hover:bg-[#3ea868] transition-colors self-start">
