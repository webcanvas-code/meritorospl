            ...
            <div>
                <h2 class="text-pretty text-4xl font-bold tracking-tight text-slate-900 mb-6 leading-tight">
                    <?php echo nl2br(str_replace(
                        ...
                        '<span class="text-[#48c279]">myślących długoterminowo</span>',
                        esc_html($title)
                    )); ?>
                </h2>
