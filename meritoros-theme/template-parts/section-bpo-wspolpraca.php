...
<section class="py-16 md:py-24 bg-emerald-50 relative">
    ...
    <div class="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div class="mt-10 md:mt-20 text-center">
            <a href="<?php echo esc_url($btn_url); ?>" class="px-8 py-4 rounded-full bg-[#48c279] text-white text-base md:text-lg font-medium hover:bg-[#3ea868] transition-colors inline-block shadow-lg shadow-emerald-500/30">
