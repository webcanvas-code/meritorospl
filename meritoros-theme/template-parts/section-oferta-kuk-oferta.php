...
<section class="py-16 md:py-24 bg-slate-50 relative overflow-hidden">
    <div class="absolute -left-24 bottom-0 w-[300px] h-[300px] rounded-full border-[40px] border-[#48c279]/8 pointer-events-none"></div>
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div class="group bg-white rounded-2xl p-8 border border-slate-200 flex flex-col gap-5 hover:border-[#48c279]/50 hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
                <span class="w-12 h-12 rounded-xl bg-[#48c279]/10 flex items-center justify-center flex-shrink-0 group-hover:bg-[#48c279]/20 transition-colors duration-300">
                    <i data-lucide="<?php echo esc_attr($karta['icon']); ?>" class="w-6 h-6 text-[#48c279]"></i>
                </span>
                ...
                <ul class="space-y-2.5 mt-auto">
                    ...
                    <li class="flex items-start gap-2 text-lg text-slate-600 leading-snug">
                        <i data-lucide="check" class="w-4 h-4 text-[#48c279] flex-shrink-0 mt-0.5"></i>
