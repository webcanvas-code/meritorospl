...
<section id="ri-sprawozdania-zarzadu" class="py-10 md:py-14 bg-emerald-50 relative overflow-hidden">
    ...
    <div class="absolute -left-32 top-1/2 -translate-y-1/2 w-[500px] h-[500px] rounded-full border-[80px] border-[#48c279]/25 pointer-events-none" aria-hidden="true"></div>
                    ...
                    <div class="flex items-center gap-3 shrink-0">
                        <?php if ($url_pdf) : ?>
                            <a href="<?php echo esc_url($url_pdf); ?>"
                               target="_blank"
                               rel="noopener"
                               class="inline-flex items-center gap-2 bg-[#48c279] hover:bg-[#3ea868] text-white text-sm font-medium px-5 py-2.5 rounded-full transition-colors">
