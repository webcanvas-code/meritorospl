...
<section id="aplikuj" class="py-16 md:py-24 bg-white relative overflow-hidden">
    ...
    <div class="absolute right-0 bottom-0 w-96 h-96 rounded-full bg-[#2d8650]/4 pointer-events-none"></div>
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-6">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            <!-- Lewa kolumna – treść -->
            <div>
                <span class="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#2d8650]/10 text-[#2d8650] text-sm font-semibold mb-6">
                ...
                <div class="flex flex-wrap gap-4">
                    <a href="<?php echo esc_url($cv_url); ?>" target="_blank" rel="noopener noreferrer"
                       class="inline-flex items-center gap-2 px-8 py-4 rounded-full bg-[#2d8650] text-white text-base font-semibold hover:bg-[#246e41] transition-colors">
            ...
            <div class="flex flex-col gap-4">
                ...
                <div class="flex items-start gap-5 bg-slate-50 rounded-2xl p-6 border border-slate-100">
                    <div class="flex-shrink-0 flex flex-col items-center gap-2">
                        <span class="w-12 h-12 rounded-xl bg-[#2d8650]/10 flex items-center justify-center">
                            <i data-lucide="<?php echo esc_attr($krok['icon']); ?>" class="w-6 h-6 text-[#2d8650]"></i>
                        </span>
                        <span class="text-xs font-bold text-[#2d8650]/60">0<?php echo $idx + 1; ?></span>
                    </div>
                    <div>
