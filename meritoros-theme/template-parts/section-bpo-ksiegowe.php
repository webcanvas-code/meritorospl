...
<section id="bpo-ksiegowe" class="py-12 md:py-24 bg-white relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div class="flex justify-center">
            <a href="<?php echo esc_url($btn_url); ?>" class="mer-btn mer-btn--secondary px-8 py-3 rounded-full border border-slate-300 text-slate-700 text-base font-medium hover:bg-slate-50 transition-colors">
