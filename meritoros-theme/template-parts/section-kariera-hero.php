...
<section id="kariera-hero" class="relative overflow-hidden" style="min-height:100vh;">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-6 flex flex-col justify-center" style="min-height:100vh; padding-top:7rem;">
        ...
        <div class="max-w-2xl">
            ...
            <a href="<?php echo esc_url($btn_url); ?>" class="mer-btn mer-btn--primary inline-flex items-center px-7 py-3.5 rounded-full bg-[#00d084] text-white text-base font-semibold hover:bg-[#00b872] transition-colors">
