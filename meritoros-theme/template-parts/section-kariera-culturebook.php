        ...
        <div class="bg-[#00d084] rounded-3xl overflow-hidden lg:overflow-visible relative min-h-[340px] flex items-center">
            ...
            <div class="relative z-10 px-10 lg:px-16 py-12 max-w-xl">
                ...
                <a href="<?php echo esc_url($pdf['url']); ?>" target="_blank" rel="noopener"
                   class="mer-btn mer-btn--light inline-flex items-center justify-center bg-white text-slate-900 font-semibold text-base px-8 py-3.5 rounded-full hover:bg-slate-100 transition-colors duration-200 w-fit">
