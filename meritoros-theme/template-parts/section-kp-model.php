        ...
        <div class="grid md:grid-cols-2 gap-6">
            ...
            <div class="rounded-3xl border-2 border-slate-200 p-8 flex flex-col hover:border-[#00d084] hover:shadow-lg hover:shadow-emerald-100 transition-all duration-300">
                <div class="flex items-start justify-between mb-6">
                    <div>
                        <div class="text-xs font-bold uppercase tracking-widest text-[#00d084] mb-1"><?php echo mer_esc($m1_label); ?></div>
            ...
            <div class="rounded-3xl border-2 border-slate-200 p-8 flex flex-col hover:border-[#00d084] hover:shadow-lg hover:shadow-emerald-100 transition-all duration-300">
                <div class="flex items-start justify-between mb-6">
                    <div>
                        <div class="text-xs font-bold uppercase tracking-widest text-slate-400 mb-1"><?php echo mer_esc($m2_label); ?></div>
