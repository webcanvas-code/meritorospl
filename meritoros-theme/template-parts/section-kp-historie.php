...
<section class="py-10 md:py-20 bg-white relative">
    <div class="max-w-7xl mx-auto px-6 mb-10 flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
        ...
        <div class="flex items-center gap-2 shrink-0">
            ...
            <button id="kp-historie-next" type="button" class="w-12 h-12 rounded-full bg-[#48c279] flex items-center justify-center shadow-md hover:bg-[#3ea868] transition-colors">
    ...
    <div class="max-w-7xl mx-auto px-6 mt-6 flex items-center justify-center gap-2" id="kp-historie-dots">
