        ...
        <div class="max-w-3xl w-full flex flex-col justify-center flex-1">
            ...
            <div class="flex flex-wrap items-center gap-4">
                <a href="<?php echo esc_url($btn1_url); ?>"
                   class="bg-[#48c279] text-white px-7 py-3 rounded-full text-base font-semibold hover:bg-[#3ea868] hover:shadow-lg hover:shadow-[#48c279]/30 transition-all duration-300 flex items-center gap-2 group">
