...
<section class="py-10 md:py-20 bg-white">
    <div class="max-w-7xl mx-auto px-6">
        ...
        <h2 class="text-pretty text-4xl md:text-5xl font-bold tracking-tight text-slate-900 mb-12">
            <?php echo nl2br(str_replace('Meritoros', '<span class="text-[#48c279]">Meritoros</span>', esc_html($title))); ?>
        </h2>

        <div class="grid md:grid-cols-3 gap-6">

            <!-- Card 1 -->
            <div class="bg-[#48c279] rounded-3xl p-8 flex flex-col min-h-[380px] relative overflow-hidden">
                <?php
                $raw1 = $d1_title;
                if (strpos($raw1, "\n") !== false) {
                    $d1_parts = explode("\n", $raw1, 2);
