...
<section class="py-16 md:py-24 bg-white relative overflow-hidden">
    <div class="absolute -right-32 top-1/4 w-[420px] h-[420px] rounded-full border-[40px] border-[#48c279]/20 pointer-events-none"></div>
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-6">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20">
            ...
            <div>
                <div class="flex items-center gap-3 mb-8">
                    <span class="w-10 h-10 rounded-xl bg-[#48c279]/10 flex items-center justify-center flex-shrink-0">
                        <i data-lucide="list-checks" class="w-5 h-5 text-[#48c279]"></i>
                    </span>
                ...
                <ul class="space-y-4">
                    ...
                    <li class="flex items-start gap-3">
                        <span class="w-6 h-6 rounded-full bg-[#48c279]/15 flex items-center justify-center flex-shrink-0 mt-0.5">
                            <i data-lucide="check" class="w-3.5 h-3.5 text-[#48c279]"></i>
                        </span>
        ...
        <div class="mt-16 pt-16 border-t border-slate-100">
            <div class="flex items-center gap-3 mb-8">
                <span class="w-10 h-10 rounded-xl bg-[#48c279]/10 flex items-center justify-center flex-shrink-0">
                    <i data-lucide="cpu" class="w-5 h-5 text-[#48c279]"></i>
                </span>
