                ...
                <div class="wi-card group bg-white rounded-2xl overflow-hidden border border-slate-200 shadow-sm hover:shadow-md hover:border-slate-300 transition-all duration-200 flex flex-col"
                    ...
                    <div class="wi-play relative aspect-video overflow-hidden bg-slate-900 cursor-pointer"
                        ...
                        <div class="absolute inset-0 flex items-center justify-center pointer-events-none">
                            <span class="flex h-14 w-14 items-center justify-center rounded-full bg-white/90 text-[#48c279] shadow-lg ring-4 ring-white/20 group-hover:scale-105 transition-transform duration-200">
                    ...
                    <div class="px-5 py-4 flex items-center gap-3">
                        ...
                        <p class="text-sm font-semibold text-slate-800 leading-snug group-hover:text-[#48c279] transition-colors">
