        ...
        <div class="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
            ...
            <div class="flex-1 max-w-lg w-full">
                ...
                <a href="mailto:<?php echo esc_attr($email); ?>"
                   class="mer-btn mer-btn--primary inline-flex items-center gap-3 px-7 py-4 rounded-full bg-[#00d084] text-white text-base font-semibold hover:bg-[#00b872] transition-colors">
