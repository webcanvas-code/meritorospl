...
<section class="py-10 md:py-14 bg-white border-t border-slate-100">
    ...
    <div class="relative">
        ...
        <!-- Przyciski -->
        <button id="ri-rada-prev" class="absolute left-6 top-1/2 -translate-y-1/2 w-14 h-14 rounded-full bg-white text-slate-400 border border-slate-200 flex items-center justify-center shadow hover:bg-slate-50 transition-colors z-10 opacity-0 pointer-events-none" aria-label="<?php echo esc_attr(__('Poprzedni', 'meritoros')); ?>">
            <i data-lucide="chevron-left" class="w-6 h-6 stroke-[2]"></i>
        </button>
        <button id="ri-rada-next" class="absolute right-6 top-1/2 -translate-y-1/2 w-14 h-14 rounded-full bg-[#00d084] text-white flex items-center justify-center shadow-lg hover:bg-[#00b872] transition-colors z-10" aria-label="<?php echo esc_attr(__('Następny', 'meritoros')); ?>">
