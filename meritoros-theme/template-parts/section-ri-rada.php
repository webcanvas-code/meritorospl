...
<section class="py-10 md:py-14 bg-white border-t border-slate-100">
    ...
    <div class="relative">
        ...
        <button id="ri-rada-next" class="absolute right-6 top-1/2 -translate-y-1/2 w-14 h-14 rounded-full bg-[#48c279] text-white flex items-center justify-center shadow-lg hover:bg-[#3ea868] transition-colors z-10" aria-label="Następny">
