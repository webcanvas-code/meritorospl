...
<section id="ri-uchwaly" class="py-10 md:py-14 bg-emerald-50 relative overflow-hidden">
                ...
                <div class="bg-white rounded-2xl px-6 py-5 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                    ...
                    <?php if ($file_url) : ?>
                        <a href="<?php echo esc_url($file_url); ?>"
                           target="_blank"
                           rel="noopener"
                           class="inline-flex items-center gap-2 bg-[#00d084] hover:bg-[#00b872] text-white text-sm font-medium px-5 py-2.5 rounded-full transition-colors shrink-0">
