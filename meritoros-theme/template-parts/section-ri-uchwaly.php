...
$title = __(get_field('ri_uch_title', $_ri_pid) ?: 'Uchwały podejmowane przez Zgromadzenie Akcjonariuszy' , 'meritoros');

// Pozycje – 10 osobnych grup ACF (ri_uch_item_1 … ri_uch_item_10)
$items = [];
for ($i = 1; $i <= 10; $i++) {
    $item = get_field("ri_uch_item_{$i}", $_ri_pid);
