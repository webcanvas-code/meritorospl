...
<section class="relative py-16 md:py-24 overflow-hidden">
    ...
    <div class="relative z-10 max-w-3xl mx-auto px-6 text-center">
        ...
        <a href="<?php echo esc_url($btn_url); ?>" class="inline-flex items-center gap-2 px-8 py-4 rounded-full bg-[#48c279] text-white text-base font-semibold hover:bg-[#3ea868] transition-colors">
