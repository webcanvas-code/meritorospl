...
<section class="py-16 md:py-20 bg-emerald-50">
    <div class="max-w-7xl mx-auto px-6 mb-10 flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
        ...
        <div class="hidden sm:flex items-center gap-2 shrink-0">
            ...
            <button id="dkar-next" class="w-12 h-12 rounded-full bg-[#00d084] flex items-center justify-center shadow-md hover:bg-[#00b872] transition-colors">
    ...
    <div class="max-w-7xl mx-auto px-6 mt-6">
        <div class="flex items-center gap-4 sm:justify-center">
            ...
            <div class="flex flex-1 sm:flex-none items-center justify-center gap-2" id="dkar-dots">
                ...
                <button class="dkar-dot rounded-full transition-all duration-300 <?php echo $idx === 0 ? 'w-6 h-2 bg-[#00d084]' : 'w-2 h-2 bg-slate-300'; ?>" data-i="<?php echo $idx; ?>"></button>
                <?php endforeach; ?>
            </div>
            <button id="dkar-next-m" class="sm:hidden w-12 h-12 rounded-full bg-[#00d084] flex items-center justify-center shadow-md hover:bg-[#00b872] transition-colors">
                <i data-lucide="chevron-right" class="w-5 h-5 text-white stroke-[2]"></i>
            </button>
        </div>
    </div>
...
(function () {
    ...
    function updateDots(max) {
        dots.forEach(function (d, i) {
            d.className = 'dkar-dot rounded-full transition-all duration-300 ' + (i === current ? 'w-6 h-2 bg-[#00d084]' : 'w-2 h-2 bg-slate-300');
