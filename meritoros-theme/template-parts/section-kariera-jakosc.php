    ...
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center mb-16">
            <div class="relative">
                ...
                <div class="flex items-center justify-center gap-2 mt-5" id="jakosc-dots">
                    ...
                    <button class="jakosc-dot <?php echo $idx === 0 ? 'w-2.5 h-2.5 bg-[#48c279]' : 'w-2 h-2 bg-slate-300 hover:bg-slate-400'; ?> rounded-full transition-all" data-idx="<?php echo $idx; ?>"></button>
                    <?php endforeach; ?>
                </div>
            </div>
            ...
            <div class="relative">
                ...
                <div class="relative z-10">
                    ...
                    <h2 class="text-pretty text-4xl md:text-5xl font-bold tracking-tight leading-tight mb-8 text-[#48c279]"><?php echo mer_esc($green); ?></h2>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
            ...
            <div class="border border-emerald-200 rounded-2xl p-8 flex flex-col items-start gap-5 hover:shadow-sm transition-shadow">
                <i data-lucide="<?php echo esc_attr($card['icon']); ?>" stroke-width="1" class="w-12 h-12 text-[#48c279]"></i>
...
(function () {
    ...
    function goTo(idx) {
        ...
        dots.forEach(function (d, i) {
            d.classList.toggle('bg-[#48c279]', i === idx);
