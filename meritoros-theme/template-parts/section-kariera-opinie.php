...
(function () {
    ...
    for (var i = 0; i < total; i++) {
        ...
        dot.className = 'rounded-full transition-all duration-300 ' + (i === 0 ? 'w-5 h-2 bg-[#00d084]' : 'w-2 h-2 bg-slate-300');
    ...
    function updateDots() {
        dotsContainer.querySelectorAll('button').forEach(function (d, i) {
            d.className = 'rounded-full transition-all duration-300 ' + (i === current ? 'w-5 h-2 bg-[#00d084]' : 'w-2 h-2 bg-slate-300');
        });
    }
