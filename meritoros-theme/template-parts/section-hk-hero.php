<?php
$title    = __( mer_field('hk_hero_title',    'Historie klientów'), 'meritoros' );
$text     = __( mer_field('hk_hero_text',     'Konkretne przypadki. Konkretny efekt. Zobacz, jak pomagamy firmom działać stabilnie i bezpiecznie.'), 'meritoros' );
$btn_text = __( mer_field('hk_hero_btn_text', 'Poznaj historie'), 'meritoros' );
...
<section class="pt-36 pb-16 bg-white relative">
    ...
    <div class="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div class="max-w-3xl">
            ...
            <a href="<?php echo esc_url($btn_url); ?>" class="mer-btn mer-btn--secondary inline-flex items-center gap-2 px-7 py-3.5 rounded-full border border-slate-300 text-slate-700 text-base font-semibold hover:bg-slate-50 transition-colors">
