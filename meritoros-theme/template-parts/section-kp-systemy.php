<?php
$title = __( mer_field('kp_sys_title', "Obsługa wielu systemów\nksiągowych"), 'meritoros' );
$text  = __( mer_field('kp_sys_text',  'Nasz zespół obsługuje wiele systemów księgowych, m.in. Comarch Optima, SAP czy Enova. Współpracę dostosowujemy do istniejących narzędzi i procesów oraz wymagań klienta. Istnieje także możliwość pracy na preferowanych przez klienta programach księgowych.'), 'meritoros' );
...
<section id="kp-systemy" class="py-12 md:py-24 border-t border-slate-100 bg-white">
