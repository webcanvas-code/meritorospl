...
<section id="oferty" class="py-16 md:py-24 bg-white relative">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-6">
        ...
        <div class="flex flex-wrap gap-3 mb-10" id="oferty-filters">
            <button data-filter="all" class="oferty-filter px-5 py-2 rounded-full text-sm font-medium bg-[#48c279] text-white transition-colors"><?php esc_html_e('Wszystkie', 'meritoros'); ?></button>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6" id="oferty-grid">
            ...
            <div class="oferta-card group border border-slate-200 rounded-2xl p-8 flex flex-col gap-5 bg-white hover:bg-[#48c279] hover:border-transparent transition-all duration-300 cursor-pointer" data-cat="<?php echo esc_attr($o['cat']); ?>">
                <i data-lucide="file-text" stroke-width="1" class="w-10 h-10 text-[#48c279] group-hover:text-white/80 transition-colors duration-300"></i>
                <div class="flex-1">
                    ...
                    <div class="flex flex-wrap gap-2">
                        ...
                        <span class="inline-flex items-center px-3 py-1.5 rounded-full text-sm font-medium bg-slate-100 text-slate-600 group-hover:bg-[#3ea868] group-hover:text-white transition-colors duration-300"><?php echo mer_esc($badge); ?></span>
                        <?php endforeach; ?>
                    </div>
                    <?php endif; ?>
                </div>
                <div class="flex flex-wrap gap-2">
                    ...
                    <a href="<?php echo esc_url($o['traffit_url']); ?>" target="_blank" rel="noopener noreferrer"
                       class="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-[#48c279] text-white group-hover:bg-white group-hover:text-slate-900 text-sm font-medium transition-all duration-300">
                    ...
                    <a href="<?php echo esc_url($o['url']); ?>"
                       class="inline-flex items-center gap-2 px-5 py-2.5 rounded-full border border-[#48c279]/50 text-[#48c279] group-hover:border-white/50 group-hover:text-white text-sm font-medium transition-all duration-300">
        ...
        <div class="mt-12 text-center">
            <a href="#rekrutacja"
               ...
               class="inline-flex items-center gap-2 px-8 py-4 rounded-full border-2 border-[#48c279] text-[#48c279] font-semibold text-base hover:bg-[#48c279] hover:text-white transition-colors duration-200">
    ...
    filters.forEach(function (btn) {
        btn.addEventListener('click', function () {
            ...
            filters.forEach(function (b) {
                b.classList.remove('bg-[#48c279]', 'text-white');
                b.classList.add('border', 'border-slate-300', 'text-slate-700');
            });
            btn.classList.add('bg-[#48c279]', 'text-white');
