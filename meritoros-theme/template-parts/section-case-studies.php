                ...
                <article class="cs-slide min-w-full flex flex-col lg:grid lg:grid-cols-12 lg:min-h-[min(520px,70vh)]" aria-roledescription="slide">
                    ...
                    <div class="order-2 lg:order-1 lg:col-span-5 flex flex-col justify-center p-6 sm:p-8 lg:p-10 xl:p-12">
                        <?php if (empty($item['is_general'])) : ?>
                            <p class="text-[11px] uppercase tracking-[0.2em] font-semibold text-[#00d084] mb-2">
                        ...
                        <a href="<?php echo esc_url($item['cta_url']); ?>"
                           class="inline-flex w-full sm:w-auto min-h-[48px] items-center justify-center gap-2 rounded-full bg-[#00d084] px-5 py-3.5 text-sm font-semibold text-white shadow-md shadow-[#00d084]/25 transition hover:bg-[#00b872] hover:shadow-lg hover:shadow-[#00d084]/30 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#00d084] group/cta">
        ...
        <div class="mt-6 flex flex-col items-stretch gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div class="flex items-center justify-center gap-2 sm:justify-start">
                ...
                <button type="button" id="cs-next"
                        class="inline-flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-[#00d084] text-white shadow-md shadow-[#00d084]/25 transition hover:bg-[#00b872] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#00d084]"
