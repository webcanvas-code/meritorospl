...
<section class="py-12 bg-white">
    <div class="max-w-7xl mx-auto px-6">
        <div class="bg-[#2d8650] rounded-2xl p-10 md:p-14 flex flex-col md:flex-row items-center justify-between gap-8 text-white relative overflow-hidden">
            ...
            <div class="relative z-10 shrink-0">
                <a href="<?php echo esc_url($btn_url); ?>" class="px-8 py-4 rounded-full bg-white text-[#2d8650] text-base font-medium hover:bg-emerald-50 transition-colors inline-block">
