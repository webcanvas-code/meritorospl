            ...
            <div class="divide-y divide-slate-200">
                ...
                <div class="py-5">
                    <button
                        ...
                        <span class="text-lg sm:text-xl font-semibold text-slate-900 leading-snug group-hover:text-[#48c279] transition-colors duration-200">
                            <?php echo mer_esc($item['question']); ?>
                        </span>
                        <i data-lucide="plus"
                           class="w-5 h-5 text-[#48c279] shrink-0"
