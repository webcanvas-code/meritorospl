    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div class="flex justify-center">
            <a href="<?php echo esc_url($btn_url ?: '#'); ?>"
               class="mer-btn mer-btn--dark inline-flex items-center gap-2 px-7 py-3.5 rounded-full bg-slate-900 hover:bg-slate-700 text-white text-base font-semibold transition-colors duration-200">
