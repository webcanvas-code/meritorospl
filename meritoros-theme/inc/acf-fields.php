...
acf_add_local_field_group([
    ...
    'fields'   => [
        ...
        ['key' => 'field_mer_hero_logo_5',  'label' => 'Logo klienta 5 (opcjonalne)',  'name' => 'hero_logo_5',  'type' => 'image', 'return_format' => 'array', 'preview_size' => 'thumbnail'],
        ['key' => 'field_mer_hero_logo_6',  'label' => 'Logo klienta 6 (opcjonalne)',  'name' => 'hero_logo_6',  'type' => 'image', 'return_format' => 'array', 'preview_size' => 'thumbnail'],
        ['key' => 'field_mer_hero_logo_7',  'label' => 'Logo klienta 7 (opcjonalne)',  'name' => 'hero_logo_7',  'type' => 'image', 'return_format' => 'array', 'preview_size' => 'thumbnail'],
        ['key' => 'field_mer_hero_logo_8',  'label' => 'Logo klienta 8 (opcjonalne)',  'name' => 'hero_logo_8',  'type' => 'image', 'return_format' => 'array', 'preview_size' => 'thumbnail'],
        ['key' => 'field_mer_hero_logo_9',  'label' => 'Logo klienta 9 (opcjonalne)',  'name' => 'hero_logo_9',  'type' => 'image', 'return_format' => 'array', 'preview_size' => 'thumbnail'],
        ['key' => 'field_mer_hero_logo_10', 'label' => 'Logo klienta 10 (opcjonalne)', 'name' => 'hero_logo_10', 'type' => 'image', 'return_format' => 'array', 'preview_size' => 'thumbnail'],
        ['key' => 'field_mer_hero_logo_11', 'label' => 'Logo klienta 11 (opcjonalne)', 'name' => 'hero_logo_11', 'type' => 'image', 'return_format' => 'array', 'preview_size' => 'thumbnail'],
        ['key' => 'field_mer_hero_logo_12', 'label' => 'Logo klienta 12 (opcjonalne)', 'name' => 'hero_logo_12', 'type' => 'image', 'return_format' => 'array', 'preview_size' => 'thumbnail'],
        ['key' => 'field_mer_hero_logo_13', 'label' => 'Logo klienta 13 (opcjonalne)', 'name' => 'hero_logo_13', 'type' => 'image', 'return_format' => 'array', 'preview_size' => 'thumbnail'],
        ['key' => 'field_mer_hero_logo_14', 'label' => 'Logo klienta 14 (opcjonalne)', 'name' => 'hero_logo_14', 'type' => 'image', 'return_format' => 'array', 'preview_size' => 'thumbnail'],
        ['key' => 'field_mer_hero_logo_15', 'label' => 'Logo klienta 15 (opcjonalne)', 'name' => 'hero_logo_15', 'type' => 'image', 'return_format' => 'array', 'preview_size' => 'thumbnail'],
        ['key' => 'field_mer_hero_logo_16', 'label' => 'Logo klienta 16 (opcjonalne)', 'name' => 'hero_logo_16', 'type' => 'image', 'return_format' => 'array', 'preview_size' => 'thumbnail'],
        ['key' => 'field_mer_hero_logo_17', 'label' => 'Logo klienta 17 (opcjonalne)', 'name' => 'hero_logo_17', 'type' => 'image', 'return_format' => 'array', 'preview_size' => 'thumbnail'],
        ['key' => 'field_mer_hero_logo_18', 'label' => 'Logo klienta 18 (opcjonalne)', 'name' => 'hero_logo_18', 'type' => 'image', 'return_format' => 'array', 'preview_size' => 'thumbnail'],
        ['key' => 'field_mer_hero_logo_19', 'label' => 'Logo klienta 19 (opcjonalne)', 'name' => 'hero_logo_19', 'type' => 'image', 'return_format' => 'array', 'preview_size' => 'thumbnail'],
        ['key' => 'field_mer_hero_logo_20', 'label' => 'Logo klienta 20 (opcjonalne)', 'name' => 'hero_logo_20', 'type' => 'image', 'return_format' => 'array', 'preview_size' => 'thumbnail'],
        ['key' => 'field_mer_hero_logo_21', 'label' => 'Logo klienta 21 (opcjonalne)', 'name' => 'hero_logo_21', 'type' => 'image', 'return_format' => 'array', 'preview_size' => 'thumbnail'],
        ['key' => 'field_mer_hero_logo_22', 'label' => 'Logo klienta 22 (opcjonalne)', 'name' => 'hero_logo_22', 'type' => 'image', 'return_format' => 'array', 'preview_size' => 'thumbnail'],
        ['key' => 'field_mer_hero_logo_23', 'label' => 'Logo klienta 23 (opcjonalne)', 'name' => 'hero_logo_23', 'type' => 'image', 'return_format' => 'array', 'preview_size' => 'thumbnail'],
        ['key' => 'field_mer_hero_logo_24', 'label' => 'Logo klienta 24 (opcjonalne)', 'name' => 'hero_logo_24', 'type' => 'image', 'return_format' => 'array', 'preview_size' => 'thumbnail'],
    ],
    'location'   => $front_page_location,
    'menu_order' => 10,
    'position'   => 'normal',
...
acf_add_local_field_group([
    ...
    'fields'   => [
        ...
        ['key' => 'field_mer_t1_industry',   'label' => 'Branża',                        'name' => 'test_1_industry',      'type' => 'text', 'default_value' => '', 'instructions' => 'Np. IT, Produkcja, Handel'],
        ...
        ['key' => 'field_mer_t2_industry',   'label' => 'Branża',                        'name' => 'test_2_industry',      'type' => 'text', 'default_value' => '', 'instructions' => 'Np. IT, Produkcja, Handel'],
        ...
        ['key' => 'field_mer_t3_industry',   'label' => 'Branża',                        'name' => 'test_3_industry',      'type' => 'text', 'default_value' => '', 'instructions' => 'Np. IT, Produkcja, Handel'],

        ['key' => 'field_mer_test_tab_4', 'label' => '◆ Opinia 4', 'name' => 'test_tab_4', 'type' => 'tab'],
        ['key' => 'field_mer_t4_company', 'label' => 'Firma',                    'name' => 'test_4_company',     'type' => 'textarea',  'rows' => 1, 'default_value' => ''],
        ['key' => 'field_mer_t4_logo',    'label' => 'Logo firmy (HTML)',         'name' => 'test_4_logo_html',   'type' => 'textarea',  'rows' => 2, 'instructions' => 'Opcjonalnie. Jeśli puste — wyświetlana jest nazwa firmy.'],
        ['key' => 'field_mer_t4_quote',   'label' => 'Treść opinii',             'name' => 'test_4_quote',       'type' => 'textarea',  'rows' => 3, 'default_value' => ''],
        ['key' => 'field_mer_t4_author',  'label' => 'Imię i nazwisko',          'name' => 'test_4_author',      'type' => 'textarea',  'rows' => 1, 'default_value' => ''],
        ['key' => 'field_mer_t4_role',    'label' => 'Stanowisko / firma',       'name' => 'test_4_role',        'type' => 'textarea',  'rows' => 1, 'default_value' => ''],
        ['key' => 'field_mer_t4_init',    'label' => 'Inicjały (awatar, 2 znaki)','name' => 'test_4_initials',   'type' => 'text',      'default_value' => ''],
        ['key' => 'field_mer_t4_hl',      'label' => 'Wyróżniona karta (zielona)','name' => 'test_4_highlighted','type' => 'true_false','ui' => 1, 'default_value' => 0],
        ['key' => 'field_mer_t4_industry',   'label' => 'Branża',                        'name' => 'test_4_industry',      'type' => 'text', 'default_value' => '', 'instructions' => 'Np. IT, Produkcja, Handel'],

        ['key' => 'field_mer_test_tab_5', 'label' => '◆ Opinia 5', 'name' => 'test_tab_5', 'type' => 'tab'],
        ['key' => 'field_mer_t5_company', 'label' => 'Firma',                    'name' => 'test_5_company',     'type' => 'textarea',  'rows' => 1, 'default_value' => ''],
        ['key' => 'field_mer_t5_logo',    'label' => 'Logo firmy (HTML)',         'name' => 'test_5_logo_html',   'type' => 'textarea',  'rows' => 2, 'instructions' => 'Opcjonalnie. Jeśli puste — wyświetlana jest nazwa firmy.'],
        ['key' => 'field_mer_t5_quote',   'label' => 'Treść opinii',             'name' => 'test_5_quote',       'type' => 'textarea',  'rows' => 3, 'default_value' => ''],
        ['key' => 'field_mer_t5_author',  'label' => 'Imię i nazwisko',          'name' => 'test_5_author',      'type' => 'textarea',  'rows' => 1, 'default_value' => ''],
        ['key' => 'field_mer_t5_role',    'label' => 'Stanowisko / firma',       'name' => 'test_5_role',        'type' => 'textarea',  'rows' => 1, 'default_value' => ''],
        ['key' => 'field_mer_t5_init',    'label' => 'Inicjały (awatar, 2 znaki)','name' => 'test_5_initials',   'type' => 'text',      'default_value' => ''],
        ['key' => 'field_mer_t5_hl',      'label' => 'Wyróżniona karta (zielona)','name' => 'test_5_highlighted','type' => 'true_false','ui' => 1, 'default_value' => 0],
        ['key' => 'field_mer_t5_industry',   'label' => 'Branża',                        'name' => 'test_5_industry',      'type' => 'text', 'default_value' => '', 'instructions' => 'Np. IT, Produkcja, Handel'],

        ['key' => 'field_mer_test_tab_6', 'label' => '◆ Opinia 6', 'name' => 'test_tab_6', 'type' => 'tab'],
        ['key' => 'field_mer_t6_company', 'label' => 'Firma',                    'name' => 'test_6_company',     'type' => 'textarea',  'rows' => 1, 'default_value' => ''],
        ['key' => 'field_mer_t6_logo',    'label' => 'Logo firmy (HTML)',         'name' => 'test_6_logo_html',   'type' => 'textarea',  'rows' => 2, 'instructions' => 'Opcjonalnie. Jeśli puste — wyświetlana jest nazwa firmy.'],
        ['key' => 'field_mer_t6_quote',   'label' => 'Treść opinii',             'name' => 'test_6_quote',       'type' => 'textarea',  'rows' => 3, 'default_value' => ''],
        ['key' => 'field_mer_t6_author',  'label' => 'Imię i nazwisko',          'name' => 'test_6_author',      'type' => 'textarea',  'rows' => 1, 'default_value' => ''],
        ['key' => 'field_mer_t6_role',    'label' => 'Stanowisko / firma',       'name' => 'test_6_role',        'type' => 'textarea',  'rows' => 1, 'default_value' => ''],
        ['key' => 'field_mer_t6_init',    'label' => 'Inicjały (awatar, 2 znaki)','name' => 'test_6_initials',   'type' => 'text',      'default_value' => ''],
        ['key' => 'field_mer_t6_hl',      'label' => 'Wyróżniona karta (zielona)','name' => 'test_6_highlighted','type' => 'true_false','ui' => 1, 'default_value' => 0],
        ['key' => 'field_mer_t6_industry',   'label' => 'Branża',                        'name' => 'test_6_industry',      'type' => 'text', 'default_value' => '', 'instructions' => 'Np. IT, Produkcja, Handel'],
...
acf_add_local_field_group([
    ...
    'fields' => [
        ...
        ['key' => 'field_kar_oferta_1', 'label' => 'Oferta 1', 'name' => 'kar_oferta_1', 'type' => 'group', 'layout' => 'row', 'sub_fields' => [
            ['key' => 'field_kar_o1_title',    'label' => 'Stanowisko (PL)', 'name' => 'title',    'type' => 'text'],
            ['key' => 'field_kar_o1_title_en', 'label' => 'Stanowisko EN',   'name' => 'title_en', 'type' => 'text'],
            ['key' => 'field_kar_o1_title_uk', 'label' => 'Stanowisko UK',   'name' => 'title_uk', 'type' => 'text'],
            ['key' => 'field_kar_o1_title_ru', 'label' => 'Stanowisko RU',   'name' => 'title_ru', 'type' => 'text'],
        ...
        ['key' => 'field_kar_oferta_2', 'label' => 'Oferta 2', 'name' => 'kar_oferta_2', 'type' => 'group', 'layout' => 'row', 'sub_fields' => [
            ['key' => 'field_kar_o2_title',    'label' => 'Stanowisko (PL)', 'name' => 'title',    'type' => 'text'],
            ['key' => 'field_kar_o2_title_en', 'label' => 'Stanowisko EN',   'name' => 'title_en', 'type' => 'text'],
            ['key' => 'field_kar_o2_title_uk', 'label' => 'Stanowisko UK',   'name' => 'title_uk', 'type' => 'text'],
            ['key' => 'field_kar_o2_title_ru', 'label' => 'Stanowisko RU',   'name' => 'title_ru', 'type' => 'text'],
        ...
        ['key' => 'field_kar_oferta_3', 'label' => 'Oferta 3', 'name' => 'kar_oferta_3', 'type' => 'group', 'layout' => 'row', 'sub_fields' => [
            ['key' => 'field_kar_o3_title',    'label' => 'Stanowisko (PL)', 'name' => 'title',    'type' => 'text'],
            ['key' => 'field_kar_o3_title_en', 'label' => 'Stanowisko EN',   'name' => 'title_en', 'type' => 'text'],
            ['key' => 'field_kar_o3_title_uk', 'label' => 'Stanowisko UK',   'name' => 'title_uk', 'type' => 'text'],
            ['key' => 'field_kar_o3_title_ru', 'label' => 'Stanowisko RU',   'name' => 'title_ru', 'type' => 'text'],
        ...
        ['key' => 'field_kar_oferta_4', 'label' => 'Oferta 4', 'name' => 'kar_oferta_4', 'type' => 'group', 'layout' => 'row', 'sub_fields' => [
            ['key' => 'field_kar_o4_title',    'label' => 'Stanowisko (PL)', 'name' => 'title',    'type' => 'text'],
            ['key' => 'field_kar_o4_title_en', 'label' => 'Stanowisko EN',   'name' => 'title_en', 'type' => 'text'],
            ['key' => 'field_kar_o4_title_uk', 'label' => 'Stanowisko UK',   'name' => 'title_uk', 'type' => 'text'],
            ['key' => 'field_kar_o4_title_ru', 'label' => 'Stanowisko RU',   'name' => 'title_ru', 'type' => 'text'],
        ...
        ['key' => 'field_kar_oferta_5', 'label' => 'Oferta 5', 'name' => 'kar_oferta_5', 'type' => 'group', 'layout' => 'row', 'sub_fields' => [
            ['key' => 'field_kar_o5_title',    'label' => 'Stanowisko (PL)', 'name' => 'title',    'type' => 'text'],
            ['key' => 'field_kar_o5_title_en', 'label' => 'Stanowisko EN',   'name' => 'title_en', 'type' => 'text'],
            ['key' => 'field_kar_o5_title_uk', 'label' => 'Stanowisko UK',   'name' => 'title_uk', 'type' => 'text'],
            ['key' => 'field_kar_o5_title_ru', 'label' => 'Stanowisko RU',   'name' => 'title_ru', 'type' => 'text'],
        ...
        ['key' => 'field_kar_oferta_6', 'label' => 'Oferta 6', 'name' => 'kar_oferta_6', 'type' => 'group', 'layout' => 'row', 'sub_fields' => [
            ['key' => 'field_kar_o6_title',    'label' => 'Stanowisko (PL)', 'name' => 'title',    'type' => 'text'],
            ['key' => 'field_kar_o6_title_en', 'label' => 'Stanowisko EN',   'name' => 'title_en', 'type' => 'text'],
            ['key' => 'field_kar_o6_title_uk', 'label' => 'Stanowisko UK',   'name' => 'title_uk', 'type' => 'text'],
            ['key' => 'field_kar_o6_title_ru', 'label' => 'Stanowisko RU',   'name' => 'title_ru', 'type' => 'text'],
...
acf_add_local_field_group([
    ...
    'fields'   => [
        ...
        ['key' => 'field_kupimy_hero_btn2_text', 'label' => 'Przycisk 2 — tekst', 'name' => 'kupimy_hero_btn2_text', 'type' => 'text', 'default_value' => 'Poznaj modele'],
        ['key' => 'field_kupimy_hero_btn2_url',  'label' => 'Przycisk 2 — link',  'name' => 'kupimy_hero_btn2_url',  'type' => 'text', 'default_value' => '#kupimy-modele', 'instructions' => 'Wpisz #id sekcji (np. #kupimy-modele) lub pełny URL.'],
...
acf_add_local_field_group([
    ...
    'fields' => [
        // ── TAB: Hero ─────────────────────────────────────────────
        ['key' => 'field_media_tab_hero', 'label' => 'Hero', 'name' => '', 'type' => 'tab', 'placement' => 'top', 'endpoint' => 0],
        ['key' => 'field_media_hero_title', 'label' => 'Tytuł', 'name' => 'media_hero_title', 'type' => 'text',
         'default_value' => 'Media i informacje firmowe'],
        ['key' => 'field_media_hero_text', 'label' => 'Opis', 'name' => 'media_hero_text', 'type' => 'textarea', 'rows' => 2,
         'default_value' => 'Najważniejsze wydarzenia z życia firmy: rozwój, nowe inicjatywy, wyróżnienia i ogłoszenia.'],

        // ── TAB: Wyróżniony artykuł ───────────────────────────────
        ['key' => 'field_media_tab_art', 'label' => 'Wyróżniony artykuł', 'name' => '', 'type' => 'tab', 'placement' => 'top', 'endpoint' => 0],
        ['key' => 'field_media_art_photo', 'label' => 'Zdjęcie', 'name' => 'media_art_photo', 'type' => 'image',
         'return_format' => 'array', 'preview_size' => 'medium', 'library' => 'all'],
        ['key' => 'field_media_art_title', 'label' => 'Tytuł artykułu', 'name' => 'media_art_title', 'type' => 'text',
         'default_value' => 'Maciej Paraszczak dla Pulsu Biznesu'],
        ['key' => 'field_media_art_quote', 'label' => 'Cytat (kursywa)', 'name' => 'media_art_quote', 'type' => 'textarea', 'rows' => 3,
         'default_value' => 'Dla wielu naszych klientów jesteśmy nie tylko biurem rachunkowym, ale partnerem operacyjnym, który realnie usprawnia ich procesy biznesowe – podkreśla z Maciej Paraszczak, prezes zarządu spółki Meritoros.'],
        ['key' => 'field_media_art_bold_text', 'label' => 'Tekst pogrubiony', 'name' => 'media_art_bold_text', 'type' => 'textarea', 'rows' => 3,
        ...
        ['key' => 'field_media_art_btn_text', 'label' => 'Tekst przycisku', 'name' => 'media_art_btn_text', 'type' => 'text',
         'default_value' => 'Czytaj więcej'],
        ['key' => 'field_media_art_btn_url', 'label' => 'Link przycisku', 'name' => 'media_art_btn_url', 'type' => 'text',
         'default_value' => ''],

        // ── TAB: Sekcja wideo ─────────────────────────────────────
        ['key' => 'field_media_tab_vid', 'label' => 'Sekcja wideo', 'name' => '', 'type' => 'tab', 'placement' => 'top', 'endpoint' => 0],

        // Wideo 1 - płaskie pola (legacy)
        ['key' => 'field_media_vid_1_msg', 'label' => 'Wideo 1 (główne)', 'name' => 'media_vid_1_msg', 'type' => 'message',
         'message' => 'Pola poniżej dotyczą pierwszego slajdu wideo. Przycisk tego slajdu prowadzi do strony Historii klientów.'],
        ['key' => 'field_media_vid_title', 'label' => 'Tytuł', 'name' => 'media_vid_title', 'type' => 'text',
         'default_value' => 'Jak z MINIMALNYM ryzykiem zacząć własny biznes? Sebastian Rafalik wspomina Meritoros.'],
        ['key' => 'field_media_vid_text', 'label' => 'Opis', 'name' => 'media_vid_text', 'type' => 'textarea', 'rows' => 3,
         'default_value' => 'Sebastian Rafalik (POL–FRA) w wywiadzie dla „Zaprojektuj Swoje Życie" mówi o tym, jak uporządkowanie księgowości i kadr z Meritoros pomogło mu odblokować skalowanie biznesu i zdjąć z siebie „wąskie gardło".'],
        ['key' => 'field_media_vid_btn_text', 'label' => 'Tekst przycisku', 'name' => 'media_vid_btn_text', 'type' => 'text',
         'default_value' => 'Posłuchaj wywiadu'],
        ['key' => 'field_media_vid_btn_url', 'label' => 'Link przycisku (fallback)', 'name' => 'media_vid_btn_url', 'type' => 'text',
         'default_value' => '', 'instructions' => 'Uzupełnij gdy wideo niedostępne (np. link zewnętrzny).'],
        ['key' => 'field_media_vid_thumbnail', 'label' => 'Miniatura wideo', 'name' => 'media_vid_thumbnail', 'type' => 'image',
         'return_format' => 'array', 'preview_size' => 'medium', 'library' => 'all',
         'instructions' => 'Miniatura wyświetlana przed odtworzeniem. Jeśli puste — pobierana automatycznie z YouTube.'],
        ['key' => 'field_media_vid_url', 'label' => 'URL wideo (YouTube / Vimeo)', 'name' => 'media_vid_url', 'type' => 'text',
         'default_value' => '', 'instructions' => 'Wklej link YouTube lub Vimeo.'],
        ['key' => 'field_media_vid_file', 'label' => 'Plik wideo (mp4/webm)', 'name' => 'media_vid_file', 'type' => 'file',
         'return_format' => 'array', 'mime_types' => 'mp4,webm', 'library' => 'all',
         'instructions' => 'Alternatywnie: wgraj plik mp4/webm.'],

        // Wideo 2
        ['key' => 'field_media_vid_2', 'label' => 'Wideo 2', 'name' => 'media_vid_2', 'type' => 'group', 'layout' => 'block',
         'instructions' => 'Wideo 2 — zostaw puste jeśli nieużywane',
         'sub_fields' => [
            ['key' => 'field_media_vid_2_title', 'label' => 'Tytuł', 'name' => 'title', 'type' => 'text', 'default_value' => ''],
            ['key' => 'field_media_vid_2_text',  'label' => 'Opis',  'name' => 'text',  'type' => 'textarea', 'rows' => 3, 'default_value' => ''],
            ['key' => 'field_media_vid_2_btn',   'label' => 'Tekst przycisku', 'name' => 'btn_text', 'type' => 'text', 'default_value' => 'Obejrzyj materiał'],
            ['key' => 'field_media_vid_2_url',   'label' => 'URL wideo (YouTube / Vimeo)', 'name' => 'vid_url', 'type' => 'text', 'default_value' => '', 'instructions' => 'Wklej link YouTube lub Vimeo.'],
            ['key' => 'field_media_vid_2_thumb', 'label' => 'Miniatura wideo', 'name' => 'thumbnail', 'type' => 'image', 'return_format' => 'array', 'preview_size' => 'medium', 'library' => 'all'],
            ['key' => 'field_media_vid_2_btn_url', 'label' => 'Link do historii klienta', 'name' => 'btn_url', 'type' => 'text',
             'default_value' => '', 'placeholder' => '/historia-klienta/nazwa/',
             'instructions' => 'URL do konkretnej historii klienta - wyswietli przycisk "Poznaj historię".'],
        ]],

        // Wideo 3
        ['key' => 'field_media_vid_3', 'label' => 'Wideo 3', 'name' => 'media_vid_3', 'type' => 'group', 'layout' => 'block',
         'instructions' => 'Wideo 3 — zostaw puste jeśli nieużywane',
         'sub_fields' => [
            ['key' => 'field_media_vid_3_title', 'label' => 'Tytuł', 'name' => 'title', 'type' => 'text', 'default_value' => ''],
            ['key' => 'field_media_vid_3_text',  'label' => 'Opis',  'name' => 'text',  'type' => 'textarea', 'rows' => 3, 'default_value' => ''],
            ['key' => 'field_media_vid_3_btn',   'label' => 'Tekst przycisku', 'name' => 'btn_text', 'type' => 'text', 'default_value' => 'Obejrzyj materiał'],
            ['key' => 'field_media_vid_3_url',   'label' => 'URL wideo (YouTube / Vimeo)', 'name' => 'vid_url', 'type' => 'text', 'default_value' => '', 'instructions' => 'Wklej link YouTube lub Vimeo.'],
            ['key' => 'field_media_vid_3_thumb', 'label' => 'Miniatura wideo', 'name' => 'thumbnail', 'type' => 'image', 'return_format' => 'array', 'preview_size' => 'medium', 'library' => 'all'],
            ['key' => 'field_media_vid_3_btn_url', 'label' => 'Link do historii klienta', 'name' => 'btn_url', 'type' => 'text',
             'default_value' => '', 'placeholder' => '/historia-klienta/nazwa/',
             'instructions' => 'URL do konkretnej historii klienta - wyswietli przycisk "Poznaj historię".'],
        ]],

        // Wideo 4
        ['key' => 'field_media_vid_4', 'label' => 'Wideo 4', 'name' => 'media_vid_4', 'type' => 'group', 'layout' => 'block',
         'instructions' => 'Wideo 4 — zostaw puste jeśli nieużywane',
         'sub_fields' => [
            ['key' => 'field_media_vid_4_title', 'label' => 'Tytuł', 'name' => 'title', 'type' => 'text', 'default_value' => ''],
            ['key' => 'field_media_vid_4_text',  'label' => 'Opis',  'name' => 'text',  'type' => 'textarea', 'rows' => 3, 'default_value' => ''],
            ['key' => 'field_media_vid_4_btn',   'label' => 'Tekst przycisku', 'name' => 'btn_text', 'type' => 'text', 'default_value' => 'Obejrzyj materiał'],
            ['key' => 'field_media_vid_4_url',   'label' => 'URL wideo (YouTube / Vimeo)', 'name' => 'vid_url', 'type' => 'text', 'default_value' => '', 'instructions' => 'Wklej link YouTube lub Vimeo.'],
            ['key' => 'field_media_vid_4_thumb', 'label' => 'Miniatura wideo', 'name' => 'thumbnail', 'type' => 'image', 'return_format' => 'array', 'preview_size' => 'medium', 'library' => 'all'],
            ['key' => 'field_media_vid_4_btn_url', 'label' => 'Link do historii klienta', 'name' => 'btn_url', 'type' => 'text',
             'default_value' => '', 'placeholder' => '/historia-klienta/nazwa/',
             'instructions' => 'URL do konkretnej historii klienta - wyswietli przycisk "Poznaj historię".'],
        ]],

        // Wideo 5
        ['key' => 'field_media_vid_5', 'label' => 'Wideo 5', 'name' => 'media_vid_5', 'type' => 'group', 'layout' => 'block',
         'instructions' => 'Wideo 5 — zostaw puste jeśli nieużywane',
         'sub_fields' => [
            ['key' => 'field_media_vid_5_title', 'label' => 'Tytuł', 'name' => 'title', 'type' => 'text', 'default_value' => ''],
            ['key' => 'field_media_vid_5_text',  'label' => 'Opis',  'name' => 'text',  'type' => 'textarea', 'rows' => 3, 'default_value' => ''],
            ['key' => 'field_media_vid_5_btn',   'label' => 'Tekst przycisku', 'name' => 'btn_text', 'type' => 'text', 'default_value' => 'Obejrzyj materiał'],
            ['key' => 'field_media_vid_5_url',   'label' => 'URL wideo (YouTube / Vimeo)', 'name' => 'vid_url', 'type' => 'text', 'default_value' => '', 'instructions' => 'Wklej link YouTube lub Vimeo.'],
            ['key' => 'field_media_vid_5_thumb', 'label' => 'Miniatura wideo', 'name' => 'thumbnail', 'type' => 'image', 'return_format' => 'array', 'preview_size' => 'medium', 'library' => 'all'],
            ['key' => 'field_media_vid_5_btn_url', 'label' => 'Link do historii klienta', 'name' => 'btn_url', 'type' => 'text',
             'default_value' => '', 'placeholder' => '/historia-klienta/nazwa/',
             'instructions' => 'URL do konkretnej historii klienta - wyswietli przycisk "Poznaj historię".'],
        ]],
    ],
