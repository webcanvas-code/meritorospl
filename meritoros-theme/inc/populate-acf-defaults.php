...
function mer_run_populate_acf_defaults(bool $overwrite = false): array {
    ...
    $definitions = [
        ...
        [$kp, 'kp_m1_item_1',           'Dokumentacja pracownicza'],
        [$kp, 'kp_m1_item_2',           'Naliczanie wynagrodzeń'],
        [$kp, 'kp_m1_item_3',           'Rozliczenia i zgłoszenia do ZUS'],
        [$kp, 'kp_m1_item_4',           'Dedykowany opiekun'],
        [$kp, 'kp_m1_item_5',           'Raportowanie miesięczne'],
        [$kp, 'kp_m2_item_1',           'Obsługa samych płac'],
        [$kp, 'kp_m2_item_2',           'Rozliczenia z ZUS'],
        [$kp, 'kp_m2_item_3',           'Obsługa dokumentacji'],
        [$kp, 'kp_m2_item_4',           'Elastyczny zakres współpracy'],
        [$kp, 'kp_m2_item_5',           'Możliwość rozszerzenia zakresu'],
